"""
Script para buscar jugadores del torneo ZF 7ma y preparar asignación de puntos
"""
import os
import sys
...
if not DATABASE_URL:
    ...
    print(f"   Buscando en: {os.path.join(os.path.dirname(__file__), '.env')}")
    sys.exit(1)

# Jugadores del torneo ZF 7ma con sus puntos
JUGADORES_TORNEO_ZF = [
    {"nombre": "Montivero Federico", "puntos": 1000, "fase": "campeon"},
    {"nombre": "Diaz Alvaro", "puntos": 1000, "fase": "campeon"},
    {"nombre": "Romero Juan Pablo", "puntos": 800, "fase": "subcampeon"},
    {"nombre": "Gallardo Pablo", "puntos": 800, "fase": "subcampeon"},
    {"nombre": "Ruarte Leandro", "puntos": 600, "fase": "semis"},
    {"nombre": "Hrellac Benjamín", "puntos": 600, "fase": "semis"},
    {"nombre": "Millicay Gustavo", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Heredia Ezequiel", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Sanchez Martin", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Rodolzadovich Sebastián", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Moreno Matías", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Moreno Cristian", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Alegre Franco", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Gonzales Pablo", "puntos": 400, "fase": "cuartos"},
    {"nombre": "Vega Luis", "puntos": 100, "fase": "zona"},
    {"nombre": "Terán Marcos", "puntos": 100, "fase": "zona"},
    {"nombre": "Guerrero Facundo", "puntos": 100, "fase": "zona"},
    {"nombre": "Olivera Joaquín", "puntos": 100, "fase": "zona"},
    {"nombre": "Espejo Juan", "puntos": 100, "fase": "zona"},
    {"nombre": "Calderón Marcos", "puntos": 100, "fase": "zona"},
]
...
def main():
    print("=" * 80)
    print("BÚSQUEDA DE JUGADORES - TORNEO ZF 7MA")
    print("=" * 80)
    print()
