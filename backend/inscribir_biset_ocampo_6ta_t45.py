#!/usr/bin/env python3
"""
Inscribir pareja Biset-Ocampo en 6ta del torneo 45.
"""
import sys, os, json
...
def inscribir():
    ...
    try:
        print("=" * 70)
        print(f"INSCRIBIR BISET-OCAMPO - TORNEO {TORNEO_ID} - CATEGORÍA {CATEGORIA_NOMBRE}")
        print("=" * 70)
        ...
        # 1. Crear jugadores
        jugadores = [
            {"nombre": "Diego", "apellido": "Biset", "username": "diego.biset.t45", "email": "diego.biset.t45@driveplus.temp", "sexo": "M"},
            {"nombre": "Cristian", "apellido": "Ocampo", "username": "cristian.ocampo.6ta.t45", "email": "cristian.ocampo.6ta.t45@driveplus.temp", "sexo": "M"},
        ]
        ...
        # 2. Inscribir pareja
        print(f"\n👥 Inscribiendo pareja...")
        j1_id = ids.get("diego.biset.t45")
        j2_id = ids.get("cristian.ocampo.6ta.t45")
        ...
        s.commit()
        print(f"\n{'=' * 70}")
        print(f"✅ LISTO - Pareja Biset-Ocampo inscrita en 6ta")
        print("=" * 70)
