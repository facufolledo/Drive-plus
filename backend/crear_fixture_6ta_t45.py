...
def main():
    ...
    try:
        print("=" * 80)
        print("CREAR FIXTURE 6TA - TORNEO 45")
        print("=" * 80)
        ...
        p1 = crear_pareja(s, "VEGA", "MAXI", "MARTIN", "FACUNDO", zona_a)
        p2 = crear_pareja(s, "ROMERO", "FRANCISCO", "ROMERO", "FERNANDO", zona_a)
        p3 = crear_pareja(s, "CEJAS", "TOMAS", "REDES", "TOMAS", zona_a)
        
        crear_partido(s, p1, p2, zona_a, cat_id, VIERNES, "22:00", 2)
        crear_partido(s, p2, p3, zona_a, cat_id, VIERNES, "18:00", 3)
        crear_partido(s, p3, p1, zona_a, cat_id, VIERNES, "23:59", 3)  # 00:00 → 23:59
        ...
        p1 = crear_pareja(s, "ORTIZ", "", "SUAREZ", "", zona_b)
        p2 = crear_pareja(s, "SANCHEZ", "MARTIN", "ARREBOLA", "PUMA", zona_b)
        p3 = crear_pareja(s, "SANTILLAN", "KIKE", "PAREDES", "FABIO", zona_b)
        
        crear_partido(s, p1, p2, zona_b, cat_id, JUEVES, "23:00", 2)
        crear_partido(s, p2, p3, zona_b, cat_id, JUEVES, "01:00", 2)
        crear_partido(s, p3, p1, zona_b, cat_id, VIERNES, "23:00", 2)
        ...
        p1 = crear_pareja(s, "ONTIVERO", "SAUL", "ONTIVERO", "ISAIAS", zona_c)
        p2 = crear_pareja(s, "LLABANTE", "FEDERICO", "CORDOBA", "SANTIAGO", zona_c)
        p3 = crear_pareja(s, "LOBOS", "JAVIER", "SANTANDER", "MARIO", zona_c)
        
        crear_partido(s, p1, p2, zona_c, cat_id, VIERNES, "20:00", 2)
        crear_partido(s, p2, p3, zona_c, cat_id, JUEVES, "21:00", 3)
        crear_partido(s, p3, p1, zona_c, cat_id, JUEVES, "18:00", 3)
        ...
        p1 = crear_pareja(s, "NIETO", "AXEL", "NIETO", "STEFY", zona_d)
        p2 = crear_pareja(s, "CEBALLO", "LAZARO", "PAMELIN", "JORGE", zona_d)
        p3 = crear_pareja(s, "OLIVA", "BAUTI", "LEYES", "FRANCO", zona_d)
        
        crear_partido(s, p1, p2, zona_d, cat_id, VIERNES, "21:00", 3)
        crear_partido(s, p2, p3, zona_d, cat_id, JUEVES, "21:00", 2)
        crear_partido(s, p3, p1, zona_d, cat_id, VIERNES, "23:59", 1)  # 00:00 → 23:59
        ...
        p1 = crear_pareja(s, "GURGONE", "CRISTIAN", "PALACIO", "BENJAMIN", zona_e)
        p2 = crear_pareja(s, "CORDERO", "FERNANDO", "PEREZ", "CRISTIAN JR", zona_e)
        p3 = crear_pareja(s, "NIS", "JUAN", "FUENTES", "AGUSTIN", zona_e)
        
        crear_partido(s, p1, p2, zona_e, cat_id, VIERNES, "20:00", 1)
        crear_partido(s, p2, p3, zona_e, cat_id, JUEVES, "19:00", 2)
        crear_partido(s, p3, p1, zona_e, cat_id, VIERNES, "23:59", 2)  # 00:00 → 23:59
        ...
        p1 = crear_pareja(s, "FERREYRA", "", "BUSTOS", "", zona_f)
        p2 = crear_pareja(s, "CARRIZO", "MATIAS", "JUAREZ", "LUCAS", zona_f)
        p3 = crear_pareja(s, "BAZAN", "ISAIAS", "RODRIGUEZ", "VALENTINO", zona_f)
        
        crear_partido(s, p1, p2, zona_f, cat_id, VIERNES, "01:00", 1)
        crear_partido(s, p2, p3, zona_f, cat_id, JUEVES, "23:59", 3)  # 00:00 → 23:59
        crear_partido(s, p3, p1, zona_f, cat_id, JUEVES, "22:00", 3)
        ...
        p1 = crear_pareja(s, "TEJADA", "RODRIGO", "CORZO", "NICOLAS", zona_g)
        p2 = crear_pareja(s, "STIPANICIS", "YOYO", "FUENTES", "GERE", zona_g)
        p3 = crear_pareja(s, "MOLINA", "ALVARO", "MOLINA", "ALEJO", zona_g)
        
        crear_partido(s, p1, p2, zona_g, cat_id, JUEVES, "21:00", 1)
        crear_partido(s, p2, p3, zona_g, cat_id, JUEVES, "19:00", 1)
        crear_partido(s, p3, p1, zona_g, cat_id, JUEVES, "23:59", 1)  # 00:00 → 23:59
        ...
        p1 = crear_pareja(s, "RADOSALDOVICH", "", "", "", zona_h)
        p2 = crear_pareja(s, "BISET", "DIEGO", "OCAMPO", "CRISTIAN", zona_h)
        p3 = crear_pareja(s, "FIGUEROA", "", "BRIZUELA", "", zona_h)
        
        crear_partido(s, p1, p2, zona_h, cat_id, VIERNES, "01:00", 3)
        crear_partido(s, p2, p3, zona_h, cat_id, VIERNES, "17:00", 3)
        crear_partido(s, p3, p1, zona_h, cat_id, JUEVES, "23:00", 1)
        ...
        p1 = crear_pareja(s, "JEREMIAS", "SALAZAR", "CARRIZO", "JEREMIAS", zona_i)
        p2 = crear_pareja(s, "MATIAS", "ROSA", "MIGUEL", "ESTRADA", zona_i)
        p3 = crear_pareja(s, "LUCERO", "NICOLAS", "LUCIANO", "PAEZ", zona_i)
        
        crear_partido(s, p1, p2, zona_i, cat_id, JUEVES, "22:00", 2)
        crear_partido(s, p2, p3, zona_i, cat_id, VIERNES, "17:00", 2)
        crear_partido(s, p3, p1, zona_i, cat_id, JUEVES, "18:00", 2)
        ...
        p1 = crear_pareja(s, "SANTINO", "GONZALEZ", "RAMIRO", "GONZALES", zona_j)
        p2 = crear_pareja(s, "NAVARRO", "MARTIN", "LUNA", "GUSTAVO", zona_j)
        ...
        print("\n" + "=" * 80)
        print("✅ FIXTURE 6TA CREADO EXITOSAMENTE")
        print("=" * 80)
        print(f"Total: 10 zonas, 28 partidos")
